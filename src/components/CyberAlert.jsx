...
const CyberAlert = ({ message, onClose, variant = 'cyan', title }) => {
    ...
    return (
        <div data-testid="cyber-alert" className="fixed inset-0 bg-black/60 flex items-center justify-center p-4 z-[9999] backdrop-blur-md transform-gpu animate-in fade-in duration-300">
