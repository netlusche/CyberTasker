# Planning Release 3.0: "Grid Sync"

## Themen & Fokuspunkte
*Hier sammeln wir im Laufe unserer Planung die übergeordneten Ziele und Features für Release 3.0. Dies ist ein Major Release, das CyberTasker von einer Einzelnutzer-Lösung zu einer kollaborativen Multi-Tenant-Plattform weiterentwickelt.*
...
**US-3.0.1: Ablösung des Legacy is_admin Flags durch ein Rollenkonzept**
...
**US-3.0.2: Einführung der internen Rolle "Manager" (Globale Systemrolle)**
...
**US-3.0.3: Team-Erstellung und Default-Struktur**
* **Als** Admin
...
**US-3.0.4: Erweiterte Manager-Rechte und Directive-Zuweisung innerhalb von Teams**
...
**US-3.0.5: Sichere Upgrades (Migration bestehender Nutzer/Daten)**
* **Als** bestehender Nutzer
* **Möchte ich**, dass nach einem Update auf Release 3.0 alle meine bestehenden Directives erhalten bleiben und ich weiterhin normal weiterarbeiten kann
* **Damit** es durch den Major-Release keinen Datenverlust oder Login-Fehler gibt.
* **Akzeptanzkriterien:**
  - Es existiert ein robustes Migrations-Script, welches alte Single-User Instanzen (Pre 3.0) beim ersten Start aktualisiert.
...
**Zu US-3.0.1 bis US-3.0.4 (RBAC, Teams & Manager-Rolle):**
...
**Zu US-3.0.5 (Migration):**
- **Testfall [Upgrade Pipeline]:** Lokale Kopie einer alten v2.2 SQLite-Datenbank einspielen. `install.php` oder Upgrade-Routine triggern. Clicks im Dashboard prüfen -> Alte Daten müssen dem `Default` Team zugeordnet sein und der Login funktioniert unverändert.
